...
(function () {
  ...
  Renderer.prototype.image = function (href, title, text) {
    var out = '<img style="display:block;margin:0 auto;margin-top: 15px;box-shadow: 1px 1px 4px #DDDDDD;" src="' + href + '" alt="' + text + '"';
    if (title) {
      out += ' title="' + title + '"'
    }
    out += this.options.xhtml ? "/>" : ">";
    out += '<label style="display: block;text-align: center;margin-top: 5px;font-size: 12px;">' + text + '</label>';
    return out
  };
